  ...
  return (
    <>
      ...
      <div class="container-fluid bg-dark-subtle">
          <div class="row p-5">
            <div class="col-md-6 text-center justify-content-center" data-aos="fade-up-right">
            ...
            <div class="col-md-6 text-center justify-content-center" data-aos="fade-up-left">
              <img class="rounded-circle mb-2 mt-3" height="140" width="140" src={avatar} alt="foto perfil"></img>
              <h2 class="fw-normal">CEO</h2>
